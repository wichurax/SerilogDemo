...
var observability = builder.AddConfiguredObservability("notifications-api");
...
static bool TryParseNotificationDeliveryStatus(string? status, out NotificationsApi.Models.NotificationDeliveryStatus parsedStatus)
{
