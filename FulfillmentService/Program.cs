...
var observability = builder.AddConfiguredObservability("fulfillment-service");
...
builder.Services.Configure<FulfillmentServiceOptions>(builder.Configuration.GetSection(FulfillmentServiceOptions.SectionName));
...
static FulfillmentAttemptDto MapAttempt(FulfillmentService.Models.FulfillmentAttempt attempt)
{
