...
namespace SerilogDemo.Migrations
{
    ...
    [Migration("20260427140455_RenameBasketToCart")]
    partial class RenameBasketToCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SerilogDemo.Models.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SerilogDemo.Models.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SerilogDemo.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("FulfillmentCollectedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("FulfillmentPackedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SerilogDemo.Models.CartItem", b =>
                {
                    b.HasOne("SerilogDemo.Models.Cart", "Cart")
                        .WithMany("Items")
